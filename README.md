...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pygitguardian-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pygitguardian-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pygitguardian
# for installing globally
pixi global install pygitguardian
```
...
It is possible to list all of the versions of `pygitguardian` available on your platform:
...
```
pixi search pygitguardian --channel conda-forge
```
